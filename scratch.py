...
m1 = Missing(order=0)
m2 = Override(-1, order=1)
m3 = Interval((0, 100), (True, True), 2, mono=-1)
# m4 = Interval((18, 62), (False, True), 3, mono=1)
# m5 = Interval((18, 100), (False, True), 4, mono=1)

c1 = Constraint(m1, m2, m3, name="Age")
#c1 = Constraint(m1, m2, m3, m4, m5, name="Age")

x = np.array([np.nan, -1., 0, 18, 19, 62, 63, 100])
...
clf = XGBClassifier(min_child_weight=100, max_depth=1, learning_rate=0.1, monotone_constraints='(-1, -1)')
...
bst = BoostCardClassifier(constraints=[c1], min_child_weight=100)
